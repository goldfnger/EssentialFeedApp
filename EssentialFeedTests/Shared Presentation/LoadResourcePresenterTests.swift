...
final class LoadResourcePresenterTests: XCTestCase {
  ...
  func test_didStartLoading_displayNoErrorMessageAndStarsLoading() {
  ...
  func test_didStartLoadingResource_displayResourceAndStopsLoading() {
  ...
  private func makeSUT(
    // as example here we use String as Resource for ViewSpy which conforms to ResourceView
