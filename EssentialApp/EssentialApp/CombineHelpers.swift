...
struct AnyScheduler<SchedulerTimeType: Strideable, SchedulerOptions>: Scheduler where SchedulerTimeType.Stride : SchedulerTimeIntervalConvertible {
  ...
  // we are gonna wrap any scheduler provided here and it will erase its type behind AnyScheduler
  // but internally it will delegate messages to the provided scheduler
